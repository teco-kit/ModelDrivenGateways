...
static int
mex_plugin_copy (struct soap *soap, struct soap_plugin *dst,
...
mex_register_handle (struct soap *soap, struct mex_hooks_t *hooks)
{
  ...
  namespaces = soap_extend_namespaces ((struct Namespace *) soap->namespaces,
...
/*TODO: return void-pointer to MetadataSection */
