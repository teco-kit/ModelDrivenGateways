...
INLINE struct ws4d_subsproxy_plugin_s *ws4d_subsproxy_plugindata(
    struct ws4d_epr *epr);
...
int ws4d_subsproxy_fcreate(struct ws4d_epr *epr, struct ws4d_epr_plugin *plugin,
    void *arg);
...
ws4d_subsproxy_plugindata(struct ws4d_epr *epr)
  {
    return (struct ws4d_subsproxy_plugin_s *) ws4d_epr_get_plugindata(epr,
        ws4d_subsproxy_plugin_id);
  }
...
int ws4d_subsproxy_plugin(struct ws4d_epr *epr)
  {
    ...
    /* register plugin */
    return ws4d_epr_register_plugin(epr, ws4d_subsproxy_fcreate, NULL);
  }
    ...
    if (!plugin)
      {
        ...
        err = ws4d_epr_register_plugin(epr, ws4d_subsproxy_fcreate, NULL);
        if (err != WS4D_OK)
          {
            return NULL;
          }
        plugin = ws4d_subsproxy_plugindata(epr);
      }
...
const char *ws4d_subsproxy_getsubsman(struct ws4d_epr *epr,
    const char *id)
{
  struct ws4d_subsproxy_plugin_s *plugin = ws4d_subsproxy_plugindata(epr);
  struct ws4d_subscription *subs;
...
ws4d_time ws4d_subsproxy_getexpire(struct ws4d_epr *epr,
    const char *id)
{
  struct ws4d_subsproxy_plugin_s *plugin = ws4d_subsproxy_plugindata(epr);
  struct ws4d_subscription *subs;
...
*ws4d_subsproxy_dupsubs (struct ws4d_epr *epr, const char *id, struct ws4d_subscription *result, ws4d_alloc_list *alist)
  {
    int err;
    struct ws4d_subsproxy_plugin_s *plugin = ws4d_subsproxy_plugindata (epr);
