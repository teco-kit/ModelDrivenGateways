...
struct ws4d_kv_s *ws4d_kv_getkey(struct ws4d_list_node *kvlist, const char *key)
{
...
struct ws4d_kv_s
*ws4d_kv_createkey(struct ws4d_list_node *kvlist, const char *key, ws4d_alloc_list *alist)
{
...
int ws4d_kv_key_setintval(struct ws4d_kv_s *kventry, int integer, ws4d_alloc_list *alist)
{
...
int ws4d_kv_key_setstringval(struct ws4d_kv_s *kventry, const char *string, ws4d_alloc_list *alist)
{
...
int ws4d_kv_key_setvoidval(struct ws4d_kv_s *kventry, void *data, size_t size, ws4d_alloc_list *alist)
{
...
int ws4d_kv_dupkey(struct ws4d_kv_s *src, struct ws4d_kv_s *dst, ws4d_alloc_list *alist)
{
  int err = WS4D_OK;
  ...
  switch(src->type)
    {
      ...
      case WS4D_KEYTYPE_VOID:
        err = ws4d_kv_key_setvoidval(dst, src->val->_void.data, src->val->_void.size, alist);
        break;
      default:
        return WS4D_ERR;
    }
...
int _ws4d_kv_rmkey(struct ws4d_kv_s *del_key)
{
...
int ws4d_kv_rmkey(struct ws4d_list_node *kvlist, const char *key)
{
...
int ws4d_kv_listdup(struct ws4d_list_node *src, struct ws4d_list_node *dst, ws4d_alloc_list *alist)
{
  register struct ws4d_kv_s *cur = NULL, *next = NULL;
  int dst_empty;
...
int ws4d_kv_listclear(struct ws4d_list_node *kvlist)
{
  register struct ws4d_kv_s *cur = NULL, *next = NULL;
...
int
ws4d_epr_set_stringkey (struct ws4d_epr *epr, const char *key, const char *string)
{
  struct ws4d_eprkv_plugin_s *plugin = ws4d_eprkv_plugindata (epr);
  struct ws4d_kv_s *kv;
  int err;
...
int
ws4d_epr_get_stringkey (struct ws4d_epr *epr, const char *key, const char **string)
{
  struct ws4d_eprkv_plugin_s *plugin = ws4d_eprkv_plugindata (epr);
  struct ws4d_kv_s *kv;
...
int
ws4d_epr_set_voidkey (struct ws4d_epr *epr, const char *key, void *data, size_t size)
{
  struct ws4d_eprkv_plugin_s *plugin = ws4d_eprkv_plugindata (epr);
  struct ws4d_kv_s *kv;
  int err;
...
int
ws4d_epr_get_voidkey (struct ws4d_epr *epr, const char *key, void **data, size_t *size)
{
  struct ws4d_eprkv_plugin_s *plugin = ws4d_eprkv_plugindata (epr);
  struct ws4d_kv_s *kv;
