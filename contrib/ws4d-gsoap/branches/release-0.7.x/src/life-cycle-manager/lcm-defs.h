...
/*  7 */ {"ERROR: working directory for service already exist, take an other service-name"},
...
/* 14 */ {"ERROR: could not install service, error while writing into internal cache"},
