...
IF (NOT DPWS_XSLTPROC_BINARY)
	FIND_PROGRAM(DPWS_XSLTPROC_BINARY
		NAMES xsltproc xsltproc.exe
		PATHS ${CMAKE_SOURCE_DIR}/bin
		DOC "xslt processor for ws4d codegen tools")
	...
	ELSE (DPWS_XSLTPROC_BINARY)
		IF(DPWS_FIND_COMPONENTS MATCHES codegen)
			MESSAGE(SEND_ERROR "xsltproc not found! See http://xmlsoft.org/XSLT/ for details")
		ELSE(DPWS_FIND_COMPONENTS MATCHES codegen)
			IF ( NOT DPWS_FIND_QUIETLY )
				MESSAGE(STATUS "xsltproc not found! See http://xmlsoft.org/XSLT/ for details")
			ENDIF ( NOT DPWS_FIND_QUIETLY )
		ENDIF(DPWS_FIND_COMPONENTS MATCHES codegen)
	ENDIF (DPWS_XSLTPROC_BINARY)
ENDIF (NOT DPWS_XSLTPROC_BINARY)
