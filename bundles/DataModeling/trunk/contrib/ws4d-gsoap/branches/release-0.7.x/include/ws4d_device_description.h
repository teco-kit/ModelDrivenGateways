...
#define ws4d_device_set_FirmwareVersion(device, number) \
...
#define ws4d_device_set_SerialNumber(device, number) \
...
#define ws4d_model_set_PresentationUrl(device, url) \
  device->thisModel->PresentationUrl = (char *) url;
