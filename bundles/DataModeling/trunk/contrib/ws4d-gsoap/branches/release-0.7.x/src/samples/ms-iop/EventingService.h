...
{
    void *__dummy;	///< Visual Studio can't cope with empty structures
};
...
int __evs1__SimpleEvent(
    struct evs1__SimpleEventType*        evs1__SimpleEvent,	///< Response parameter
...
int __evs1__IntegerEvent(
    struct evs1__IntegerEventType*        evs1__IntegerEvent,	///< Response parameter
    void ///< Notification message: no request parameter    
);
