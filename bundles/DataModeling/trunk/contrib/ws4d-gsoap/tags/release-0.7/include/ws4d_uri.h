...
/** Uri struct for a convinient use of ws4d_uri's conform with rfc2396. */
struct ws4d_uri
{
 ...
 * expects all unused fields to be set to NULL. Otherwise undefined behaviour
 * is yielded.
 *
...
/**
 * Function indicates wether a specified string is an escaped ws4d_uri character.
 *
 * @code
 * escaped = "%" hex hex
...
/**
 * Function indicates wether a specified string is a valid hostname or not.
 *
 * @code
...
/**
 * Function indicates wether a specified string is a valid ipv4 address or not.
 *
 * @code
...
/**
 * Function indicates wether a specified char is a mark character or not.
 *
 * @code
 * mark = "-" | "_" | "." | "!" | "~" | "*" | "'" | "(" | ")"
 * @endcode
...
/**
 * Function indicates wether a specified string is a valid path segment or not.
 *
 * @code
 * segment      = *pchar * ( ";" param )
 * param        = *pchar
...
/**
 * Function indicates wether a specified char is an unreserved character or not.
 *
 * @code
...
/**
 * Function indicates wether a specified char is from set uric or not.
 *
 * @code
...
/**
 * Function indicates wether a specified char occurs in a specified null
...
/**
 * Function indicates wether a specified null terminated string is a valid
 ...
 * @return SOAP_OK if specified scheme is welformed, SOAP_ERR otherwise.
 */
 ...
 * @return SOAP_OK if specified userinfo is welformed, SOAP_ERR otherwise.
 */
 ...
 * @return SOAP_OK if specified host is welformed, SOAP_ERR otherwise.
 */
 ...
 * @return SOAP_OK if specified port is welformed, SOAP_ERR otherwise.
 */
 ...
 * @return SOAP_OK if specified path is welformed, SOAP_ERR otherwise.
 */
 ...
 * @return SOAP_OK if specified query is welformed, SOAP_ERR otherwise.
 */
 ...
 * @return SOAP_OK if specified fragment is welformed, SOAP_ERR otherwise.
 */
 ...
 * for a more convinient handling. The caller can influence which parts of the
 ...
 *
 * @return SOAP_OK if the ws4d_uri was welformed or SOAP_ERR otherwise.
 */
