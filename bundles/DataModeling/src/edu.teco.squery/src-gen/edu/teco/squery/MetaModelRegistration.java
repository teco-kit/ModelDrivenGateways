...
public class MetaModelRegistration {
    ...
    static {
		...
		public static void register() {
			String nsURI = "http://www.teco.edu/squery";
			if (EPackage.Registry.INSTANCE.get(nsURI) == null) {
				InputStream in = MetaModelRegistration.class.getResourceAsStream("squery.ecore");
				Resource r = TypeResolver.getResourceSet().createResource(URI.createURI("edu/teco/squery/squery.ecore"));
				try {
					r.load(in, null);
	...
	public static EPackage getEPackage() {
		return EPackage.Registry.INSTANCE.getEPackage("http://www.teco.edu/squery");
	}
		...
		if (xtextfile == null) {
			...
			try {
				...
				final URL url = ResourceLoaderFactory.createResourceLoader()
						.getResource("edu/teco/squery/sQuery.xmi");
				...
				System.out.println("Couldn't load xmi file (edu/teco/squery/sQuery.xmi)");
			} finally {
				ResourceLoaderFactory
