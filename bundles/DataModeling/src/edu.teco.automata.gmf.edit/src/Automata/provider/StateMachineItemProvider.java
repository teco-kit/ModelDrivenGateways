...
/**
 * This is the item provider adapter for a {@link Automata.StateMachine} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StateMachineItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AutomataPackage.Literals.STATE_MACHINE__STATES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AutomataPackage.Literals.STATE_MACHINE__STATES,
				 AutomataFactory.eINSTANCE.createSimpleState()));

		newChildDescriptors.add
			(createChildParameter
				(AutomataPackage.Literals.STATE_MACHINE__STATES,
				 AutomataFactory.eINSTANCE.createStartState()));

		newChildDescriptors.add
			(createChildParameter
				(AutomataPackage.Literals.STATE_MACHINE__STATES,
				 AutomataFactory.eINSTANCE.createStopState()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return AutomataEditPlugin.INSTANCE;
	}
