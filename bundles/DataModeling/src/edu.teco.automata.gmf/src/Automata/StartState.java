 ...
 * <ul>
 *   <li>{@link Automata.StartState#getOut <em>Out</em>}</li>
 * </ul>
 * </p>
 *
 * @see Automata.AutomataPackage#getStartState()
 * @model
 * @generated
 */
public interface StartState extends State {
    ...
    * <!-- end-user-doc -->
	 ...
	 * @see #setOut(State)
	 * @see Automata.AutomataPackage#getStartState_Out()
	 * @model required="true"
	 * @generated
	 */
   State getOut();
   ...
   /**
	 * Sets the value of the '{@link Automata.StartState#getOut <em>Out</em>}' reference.
	 * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
