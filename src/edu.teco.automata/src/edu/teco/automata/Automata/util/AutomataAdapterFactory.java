...
public class AutomataAdapterFactory extends AdapterFactoryImpl {
	...
	protected AutomataSwitch<Adapter> modelSwitch =
		new AutomataSwitch<Adapter>() {
			...
			@Override
			public Adapter caseTTimestamp(TTimestamp object) {
				return createTTimestampAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link edu.teco.automata.Automata.TTimestamp <em>TTimestamp</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createTTimestampAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link edu.teco.automata.Automata.IntType <em>Int Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
