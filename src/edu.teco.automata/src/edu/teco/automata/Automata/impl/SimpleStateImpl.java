 ...
 *   <li>{@link edu.teco.automata.Automata.impl.SimpleStateImpl#getEcore <em>Ecore</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SimpleStateImpl extends StateImpl implements SimpleState {
	...
	/**
	 * The cached value of the '{@link #getEcore() <em>Ecore</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getEcore()
	 * @generated
	 ...
	 * @generated
	 */
	public EClassifier getEcore() {
		if (ecore != null && ecore.eIsProxy()) {
			InternalEObject oldEcore = (InternalEObject)ecore;
			ecore = (EClassifier)eResolveProxy(oldEcore);
			if (ecore != oldEcore) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AutomataPackage.SIMPLE_STATE__ECORE, oldEcore, ecore));
			}
		}
		return ecore;
	}
	 ...
	 * @generated
	 */
	public EClassifier basicGetEcore() {
		return ecore;
	}
	 ...
	 * @generated
	 */
	public void setEcore(EClassifier newEcore) {
		EClassifier oldEcore = ecore;
		ecore = newEcore;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AutomataPackage.SIMPLE_STATE__ECORE, oldEcore, ecore));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case AutomataPackage.SIMPLE_STATE__KIND:
				return getKind();
			case AutomataPackage.SIMPLE_STATE__ECORE:
				if (resolve) return getEcore();
				return basicGetEcore();
		}
