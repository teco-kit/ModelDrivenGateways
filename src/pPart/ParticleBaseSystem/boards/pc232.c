/**
* This is the board file for particle computer communication board 232
*
* file version: 000 (2005-08-24, sabin)
*				identical to pc230.c 000
*
*/


#ifndef __PC232_C__
#define __PC232_C__             000
...
int PCGetID(byte* p_id)
{
	int res;
	IDChipOn();
	res = IDChipGetId(p_id);		// get the id and write it to p_id
	IDChipOff();
	return res;
}
