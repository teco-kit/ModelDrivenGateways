 ...
 * @generated
 */
public class AutomataBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	protected Command getSemanticCommand(IEditCommandRequest request) {
		...
		if (semanticCommand != null) {
			...
			completedRequest
					.setParameter(
							Automata.diagram.edit.helpers.AutomataBaseEditHelper.EDIT_POLICY_COMMAND,
							command);
		}
		if (elementType != null) {
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		public static boolean canCreateStartStateOut_4001(
				Automata.StartState source, Automata.State target) {
			if (source != null) {
				if (source.getOut() != null) {
					return false;
				}
			}
			return canExistStartStateOut_4001(source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canCreateSimpleStateOut_4002(
				Automata.SimpleState source, Automata.State target) {
			if (source != null) {
				if (source.getOut().contains(target)) {
					return false;
				}
			}
			return canExistSimpleStateOut_4002(source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canExistStartStateOut_4001(
				Automata.StartState source, Automata.State target) {
		 ...
		 * @generated
		 */
		public static boolean canExistSimpleStateOut_4002(
				Automata.SimpleState source, Automata.State target) {
