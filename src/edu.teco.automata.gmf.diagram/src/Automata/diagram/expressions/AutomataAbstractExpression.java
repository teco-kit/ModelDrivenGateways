 ...
 * @generated
 */
public abstract class AutomataAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = Automata.diagram.part.AutomataDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected AutomataAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
