 ...
 * @generated
 */
public class AutomataEditPartProvider extends AbstractEditPartProvider {
	 ...
	 * @generated
	 */
	public AutomataEditPartProvider() {
		setFactory(new Automata.diagram.edit.parts.AutomataEditPartFactory());
