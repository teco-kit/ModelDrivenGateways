...
static int dom_automata(struct WRITER_STRUCT *writer, ptr_stack stack,
		int *_label);
	...
	for (;;) {
		...
		case 1: //stateBegin(TimeStamp)
		{
...

			{
				...
				sens_DateTime *cur;
				while (NULL != (cur = sens_SSimpSample_next_timeStamp(
						(sens_SSimpSample *) top(), (sens_DateTime *) last))) {
					push(cur);
					write_true(writer);
		...
		case 2://stateComplexBegin(Accelleration)
		{
...

			{
				...
				if (NULL != (cur
						= sens_SSimpSample_next_accelleration(
		...
		case 8://stateComplexBegin(Audio)
		{
...

			{
				...
				if (NULL != (cur = sens_SSimpSample_next_audio(
						(sens_SSimpSample *) top(), (sens_SP101Sample *) last))) { /* depth 1*/
		...
		case 21://stateComplexBegin(Temperature)
		{
...

			{
				...
				if (NULL != (cur = sens_SSimpSample_next_temperature(
						(sens_SSimpSample *) top(), (sens_TC74Sample *) last))) { /* depth 1*/
